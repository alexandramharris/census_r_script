...
census_api_key("your-key-goes-inside-quotes", install = TRUE)
...
county_states <- county_state_hh_inc %>% 
  filter(state != "Puerto Rico") %>% 
  arrange(estimate)
